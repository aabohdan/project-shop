...
SECRET_KEY = 'django-insecure-!nhy!5onm8#w67*)2_e=%$8z+ca1ye2qg7+&azglmt!_#-z4!_'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'my_shop.context_processors.basket_count'
            ],
        },
    },
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'products/media_goods/')
MEDIA_URL = '/media/'
